...
const FAQS = [
  {
    q: '希望する塗料の色や、用意した色サンプルを正確にシミュレーションできますか？',
    a: '標準的なおすすめカラーのほか、ご自身でお持ちの外壁色画像やテクスチャサンプルをアップロードしてシミュレーションできます。AIが光の当たり方や建物の影を考慮してリアルにレンダリングするため、実際の仕上がりイメージに近い状態で確認できます。ただし、実際の塗装工事では、下地の状態や陽の当たり方で多少見え方が変化しますので、最終的な色決定の目安としてご活用ください。',
  },
  {
    q: '窓枠や屋根、ドアなどの位置や形を維持したまま、外壁の色だけを変えられますか？',
    a: 'はい。WallAIは建物の輪郭、窓の配置、ドア、サッシ、バルコニー、周囲の植栽や電線などの構造的特徴を高い精度で維持します。元の構造は維持したまま、指定した部位（1階外壁、2階外壁、アクセント・ベランダ、屋根、ドア・サッシ・雨樋・破風、または外壁全体）の色だけを置き換えます。',
  },
  {
    q: '1階と2階で異なる色を塗る（ツートンカラー）ことはできますか？',
    a: 'はい、対応しています。「1階の外壁」と「2階の外壁」でそれぞれ個別にカラーを選択して、美しいツートンカラーの塗装シミュレーションが行えます。また、外壁全体を同一色で一度に塗り替えたい場合は、「外壁全体（1階・2階一括）」を選択して簡単に指定することも可能です。※なお、AIによる画像生成の特性上、建物の複雑な構造（入り組んだベランダや凹凸の激しい外壁面など）によっては、1階と2階の境界線に一部にじみや曖昧さなどの不備が生じる場合があります。あらかじめご了承ください。',
  },
  {
  ...
  },
  {
    ...
    a: 'シミュレーションした「施工前（ビフォー）」と「塗装完成イメージ（アフター）」を並べ、選択したメイン外壁・アクセント・屋根・サッシの色名称とカラーコード、および時間帯設定を1枚にまとめたプロフェッショナルな報告書です。印刷して施主様への提案資料にしたり、塗装業者との打ち合わせにそのまま使えます。',
  },
];
