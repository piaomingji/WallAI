...
const FAQS = [
  {
    ...
    a: '標準的なおすすめカラーのほか、ご自身でお持ちの外壁色画像やテクスチャサンプルをアップロードしてシミュレーションできます。AI가 光の当たり方や建物の影を考慮してリアルにレンダリングするため、実際の仕上がりイメージに非常に近い状態で確認できます。ただし、実際の塗装工事では、下地の状態や陽の当たり方で多少見え方が変化しますので、最終的な色決定の目安としてご活用ください。',
  },
  {
